...
# -*- coding: utf-8 -*-
#
# DCscope documentation build configuration file, created by
...
# Get version number from dcscope._version file
...
rst_prolog = """
:github_url: https://github.com/DC-analysis/DCscope
"""
...
project = 'DCscope'
github_project = 'DC-analysis/DCscope'
...
# This gets 'version'
release = dcscope.__version__  # noqa: F821
...
html_logo = "artwork/dcscope_large_white.png"
...
latex_documents = [
    (master_doc, 'dcscope.tex', 'DCscope Documentation',
     author, 'manual'),
]
...
man_pages = [
    (master_doc, 'dcscope', 'DCscope Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'dcscope', 'DCscope Documentation',
     author, 'dcscope', 'post-measurement analysis of RT-DC data sets',
     'Scientific'),
]
